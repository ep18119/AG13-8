...
var $author$project$AG2$viewASTxy = F3(
	function (model, te, _v0) {
		...
		var x = _v3.a;
		var y = _v3.b;
		return ((!te) && (!_Utils_eq(model.v, n.a))) ? A3($elm$html$Html$Keyed$node, 'div', _List_Nil, _List_Nil) : ((te && (!_Utils_eq(model.S, n.a))) ? A3($elm$html$Html$Keyed$node, 'div', _List_Nil, _List_Nil) : A3(
			$elm$html$Html$Keyed$node,
			'div',
			_List_fromArray(
				[
				...
				A2(
					...
					F2(
						function (index, tab) {
							return _Utils_Tuple2(
								$elm$core$String$fromInt(index),
								A3($author$project$AG2$viewTab, tab, model.v, false));
						}),
